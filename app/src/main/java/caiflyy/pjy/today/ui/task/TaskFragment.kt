...
import caiflyy.pjy.today.ui.task.decoration.*
import caiflyy.pjy.today.ui.task.item.*
...
class TaskFragment : Fragment() {
    ...
    private val prefs: Prefs by lazy { Prefs.get(context) }
    private val handler = Handler()

    private val gray: Int by lazy { ContextCompat.getColor(context!!, R.color.lineColor) }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        populateAdapter()
        groupLayoutManager = GridLayoutManager(context!!, groupAdapter.spanCount).apply {
        ...
        ItemTouchHelper(touchCallback).attachToRecyclerView(rcv_task)
    }
    ...
    private val onShuffleClicked = View.OnClickListener {
        ...
        rcv_task.post { rcv_task.invalidateItemDecorations() }
    }
